...
-- ============================================================
-- 038_cancelamento_lancamento_semi_acabado_DEV_PROPOSTA_GAIA.sql
...
COMMENT ON COLUMN desenvolvimento.semi_acabado_lancamento.cancelado_em IS 'FugaPET incremental 038 semi_acabado_cancelamento';
COMMENT ON COLUMN desenvolvimento.semi_acabado_lancamento.cancelado_por IS 'FugaPET incremental 038 semi_acabado_cancelamento';
COMMENT ON COLUMN desenvolvimento.semi_acabado_lancamento.motivo_cancelamento IS 'FugaPET incremental 038 semi_acabado_cancelamento';
...
COMMENT ON CONSTRAINT ck_semi_acabado_lancamento_status ON desenvolvimento.semi_acabado_lancamento IS 'FugaPET incremental 038 semi_acabado_cancelamento';
...
COMMENT ON CONSTRAINT ck_semi_acabado_lancamento_cancelamento_local ON desenvolvimento.semi_acabado_lancamento IS 'FugaPET incremental 038 semi_acabado_cancelamento';
...
COMMENT ON INDEX desenvolvimento.uq_semi_acabado_lancamento_aberto_por_op_item IS 'FugaPET incremental 038 semi_acabado_cancelamento';

COMMIT;

\echo 'OK - APLICACAO 038 DEV concluida'
