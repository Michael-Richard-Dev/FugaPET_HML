...
public partial class ConsultaEtiquetaForm : Form
{
    ...
    private readonly List<EtiquetaGridItem> _todasOrdens = new();
    private bool _placeholderPesquisaAtivo = true;
    private const string PlaceholderPesquisa = "Pesquisar etiqueta, lote ou produto...";
    ...
    {
        _todasOrdens.Add(new EtiquetaGridItem(op, data, lote, produto, descricao, passo, caixasPrev, caixasLidas, percent));
    }
    ...
    private void AplicarFiltroPesquisa(string termo)
    {
        ...
        List<EtiquetaGridItem> resultado = _todasOrdens
            .Where(o =>
    ...
    private void RenderOrders(IEnumerable<EtiquetaGridItem> ordens)
    {
        ordersDataGridView.Rows.Clear();
        foreach (EtiquetaGridItem ordem in ordens)
        {
    ...
    private sealed record EtiquetaGridItem(
        string Op,
        string Data,
        string Lote,
        string Produto,
