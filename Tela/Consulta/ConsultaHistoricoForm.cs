...
public partial class ConsultaHistoricoForm : Form
{
    ...
    private readonly List<HistoricoGridItem> _todosRegistros = [];
    ...
    private void LoadMockData()
    {
        ...
        AddHistoricoItem("04/05/2026 13:36:22", "Leitura", "58895", "PE - TURMA DA MONICA CARNE E LEITE", "131 262F", "7891234567890", "16,000", "KG", "OPERADOR01", "Balanca F12", "Sucesso");
        AddHistoricoItem("04/05/2026 13:32:45", "Producao", "58894", "MP PULMAO CONG BOVINO NT CONGELADO", "---", "---", "16,000", "KG", "OPERADOR01", "Manual", "Sucesso");
        AddHistoricoItem("04/05/2026 13:28:11", "Pesagem", "58893", "MP C.M.S DE FRANGO NT CONGELADO", "---", "---", "4,000", "KG", "OPERADOR02", "Balanca F8", "Sucesso");
        AddHistoricoItem("04/05/2026 13:21:05", "Integracao SAP", "58892", "PEITO DE FRANGO S/OSSO CONGELADO", "---", "---", "8,000", "KG", "SISTEMA", "Automatico", "Enviado");
        AddHistoricoItem("04/05/2026 13:15:30", "Leitura", "58891", "MP FIGADO DE FRANGO CONGELADO", "---", "7899876543210", "4,000", "KG", "OPERADOR01", "Balanca F12", "Sucesso");
        AddHistoricoItem("04/05/2026 13:09:47", "Producao", "58890", "COXA E SOBRECOXA CONGELADA", "---", "---", "12,000", "KG", "OPERADOR02", "Manual", "Sucesso");
        AddHistoricoItem("04/05/2026 12:55:12", "Leitura", "58889", "ASA DE FRANGO CONGELADA", "---", "7891112223334", "10,000", "KG", "OPERADOR01", "Balanca F12", "Sucesso");
        AddHistoricoItem("04/05/2026 12:42:33", "Integracao SAP", "58888", "LINGUICA DE FRANGO CONGELADA", "---", "---", "6,000", "KG", "SISTEMA", "Automatico", "Erro");

        RenderHistorico(_todosRegistros);
    }

    private void AddHistoricoItem(string dataHora, string tipo, string op, string produto, string lote, string codigoBarras, string qtd, string unid, string usuario, string origem, string situacao)
    {
        _todosRegistros.Add(new HistoricoGridItem(dataHora, tipo, op, produto, lote, codigoBarras, qtd, unid, usuario, origem, situacao));
    }
    ...
    private void AplicarFiltroPesquisa(string termo)
    {
        ...
        List<HistoricoGridItem> resultado = _todosRegistros
            .Where(r =>
    ...
    private void RenderHistorico(IEnumerable<HistoricoGridItem> registros)
    {
        ordersDataGridView.Rows.Clear();
        foreach (HistoricoGridItem item in registros)
        {
    ...
    private sealed record HistoricoGridItem(
        string DataHora,
        string Tipo,
        string Op,
        string Produto,
